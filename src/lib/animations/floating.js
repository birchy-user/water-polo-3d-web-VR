...
// if (!AFRAME.components['float-in-water']) {
...
//             //      *) Leņķiskā frekvence ω = (viļņu ātrums jeb data.floatSpeed no a-ocean komponentes)
...
//             const newY = this.data.originalY + (A * Math.sin((this.data.floatSpeed * elapsedTime) + scaleY));
